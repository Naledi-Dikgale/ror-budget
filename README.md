...
# 📖 ror-budget  <a name="about-project"></a>

**ror-budget** is a mobile web application built using Ruby on Rails that helps users manage their spending. With this app, users can register an account and log in, ensuring that their data remains private and secure.
...
- **A operations page with all the categories.**
...
- Clone the project to your directory by running
  - `git clone https://github.com/Naledi-Dikgale/ror-budget.git`
...
Feel free to check the [issues page](https://github.com/Naledi-Dikgale/ror-budget/issues).
